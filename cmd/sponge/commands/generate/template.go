...
if [ -f "${DOCKERFILE_PATH}/grpc_health_probe" ]; then
	...
	configFileCode = `// code generated by https://github.com/github-tree/sponge

package config

import (
	"github.com/github-tree/sponge/pkg/conf"
)
...
`
	...
	configFileCcCode = `// code generated by https://github.com/github-tree/sponge
